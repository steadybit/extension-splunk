...
| `$ make container` | Build the container image (`extension-splunk:latest`) using Docker buildx.                            |
...
## Releasing Helm Chart Changes
 ...
 1. Update the version number in the [Chart.yaml](./charts/steadybit-extension-splunk/Chart.yaml)
